...
def load_data():
    ...
    url_items   = "https://drive.google.com/uc?export=download&id=163b-CGyWRafz-1ZRT0XNepi70MyRzg7O"
    url_refunds = "https://drive.google.com/uc?export=download&id=1di14Gd4eNh5norDomih8G7Gw57Kz358L"
    ...
    order_items = pd.read_csv(url_items)
    order_item_refunds = pd.read_csv(url_refunds)
